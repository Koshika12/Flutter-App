                ...
                child: IntrinsicHeight(
                  child: Column(
                    children: [
                      ...
                      const Text("BCA STUDENT APP", style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
                      SizedBox(height: size.height * 0.035),
                      const Text("Sign in to PKMC BCA", style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
                      const SizedBox(height: 6),
                      const Text("Welcome back, student!", style: TextStyle(fontSize: 17, color: Colors.grey)),
                      SizedBox(height: size.height * 0.03),
                      Align(
                        alignment: Alignment.centerLeft,
                        child: Text("Email Address", style: TextStyle(fontWeight: FontWeight.w600, color: Colors.grey.shade800)),
                      ),
                        ...
                        children: [
                          ...
                          TextButton(
                            ...
                            child: const Text("Forgot Password?",
                                style: TextStyle(color: Color(0xFF2142B2), fontWeight: FontWeight.bold)),
                          ),
                        ],
                      ),
